...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsx("div",{className:"CommentInfo__body",children:e.body}),R.jsx("strong",{className:"CommentInfo__name",children:e.name}),R.jsx("p",{children:R.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})})]}),Lc=({comments:e})=>R.jsx("ul",{className:"CommentList",children:e.map(t=>R.jsx("li",{className:"CommentList__item",children:R.jsx(Pc,{comment:t})},t.id))}),Tc=({user:e})=>R.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:R.jsx("div",{className:"UserInfo__name",children:e.name})}),Mc=({post:e})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),e.user&&R.jsxs("p",{children:[" Posted by ",R.jsx(Tc,{user:e.user})]})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),R.jsx("hr",{}),e.comments.length?R.jsx(Lc,{comments:e.comments}):R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({enrichedPosts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{post:t,comments:t.body},t.id))}),Dc=Cc.map(e=>({...e,user:Nc.find(t=>t.id===e.userId),comments:zc.filter(t=>t.postId===e.id)})),jc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{enrichedPosts:Dc})]});em(document.getElementById("root")).render(R.jsx(jc,{}));
